...
export default function EditCardModal({ id, name, description, priority, deadline, onClose }) {
  ...
  const onSubmit = data => {
    ...
    if (data.description !== description) changes.description = data.description;
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={css.options}>
          {['low', 'medium', 'high', 'without'].map(priority => (
            <label key={priority} className={clsx([css.priorityOpt, css.customRadio])}>
