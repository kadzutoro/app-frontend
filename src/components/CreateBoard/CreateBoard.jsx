...
import { addBoard, editBoard, fetchOneBoard } from '../../redux/tasks/operations';
  ...
  return (
    <div className={css.container}>
      ...
      <ul className={css.bgList}>
        <li className={selectedBackground.name === '' ? css.selectedBgItemIcon : css.bgItemIcon}>
            ...
            return (
              <li className={css.bgItem} key={index}>
                ...
                <label htmlFor={`bg-${index}`}>
                  <picture>
                    <source srcSet={`${bg.mini2x} 2x`} media="(min-width: 375px)" />

                    <img
                      className={selectedBackground.name === bg.name ? css.selectedBg : css.bg}
                      src={bg.mini}
                      alt={bg.name}
                    />
                  </picture>
      ...
      {isEdit ? (
        <Button type="submit" onClick={handleSubmitEdit} className={css.btnPlus}>
        ...
        <Button type="submit" onClick={handleSubmitCreate} className={css.btnPlus}>
          <div className={css.svgBox}>
            <svg className={css.iconPlus}>
              <use href={`${Icon}#icon-plus`}></use>
            </svg>
